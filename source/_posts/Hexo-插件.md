...
![github-setting](Hexo-插件/github-setting.png)

![](Hexo-插件/github-profile.png)



> 完成后结果如下:
![github-cards](Hexo-插件/github-cards.png)
...
```
> 最后表现为:
![weiboShow](Hexo-插件/weiboShow.png)

# 本地图片无法再网上显示？？
请参考链接---->[hexo 中无痛使用本地图片](http://www.tuicool.com/articles/umEBVfI)
<font color='red'>切记 文章名要和图片目录名一致！！！！</font>
# 更多详情请参考
